...
// Icons are still needed for rendering if connector.icon is passed directly,
// but connectorCategories (which defines icons) is now imported.
// The actual icon components are defined in the imported connectorCategories.
import {
  IconChevronDown,
  IconChevronRight,
...
import { connectorCategories } from "@/lib/connectors"; // Import from new location
